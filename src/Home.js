...
const Styles = styled.div`
  ...
  .thefront {
    ...
    border-image: url(https://www.freepnglogos.com/uploads/border-png/double-line-border-png-10.png)
      20% round;
  }
  .theback {
    position: absolute;
                ...
                <div className="thecard">
                  ...
                  <div className="theback">
                    ...
                    <img
                      ...
                      src="https://cdn-media-1.freecodecamp.org/images/1*LMEECiXhk715h-VCFyb-GA.jpeg"
                      alt="logo.png"
                    ></img>
                  </div>
                </div>
              ...
              <div data-aos="fade-right" className="maincontainer">
                <div className="thecard">
                  ...
                  <div className="theback">
                    ...
                    <p>
                      Please Also Visit the Skills Link Above to see more of my
                      skills !
                    </p>
                  </div>
                </div>
